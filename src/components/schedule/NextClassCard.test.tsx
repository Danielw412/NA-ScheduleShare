...
describe('NextClassCard', () => {
  ...
  it('opens the entire current-day bell schedule in an accessible dialog', async () => {
    ...
    expect(dialog.querySelector('.bell-schedule-row-time')).toHaveTextContent('7:28 AM')
    expect(dialog.querySelector('.bell-schedule-row-time > [aria-hidden="true"]')).toHaveTextContent('-')
    expect(dialog.querySelector('.bell-schedule-row-time')).toHaveTextContent('8:08 AM')
