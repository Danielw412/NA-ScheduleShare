...
describe('BellScheduleAdminPanel', () => {
  ...
  it('updates the exact homepage preview from manual date and time controls', async () => {
    ...
    expect(screen.getByRole('heading', { name: /AP Psychology over in/ })).toHaveTextContent('28:00')
    ...
    expect(screen.getByRole('heading', { name: /AP Psychology over in/ })).toHaveTextContent('35:00')
    ...
    expect(screen.getByRole('heading', { name: /Current class over in/ })).toBeInTheDocument()
  })
})
