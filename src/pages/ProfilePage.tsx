  ...
  return <div className="profile-page narrow-page">
    ...
    <form className="profile-form" onSubmit={(event) => void saveProfile(event)}>
      ...
      <section className="profile-card" aria-labelledby="profile-privacy-heading">
        <div className="profile-section-heading"><ShieldCheck aria-hidden="true" /><div><h2 id="profile-privacy-heading">Schedule privacy</h2><p>These existing rules are enforced by PostgreSQL and take effect as soon as you save.</p></div></div>
