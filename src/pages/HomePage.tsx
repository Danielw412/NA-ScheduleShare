      ...
      <section className="home-hero">
        <div>
          ...
          <p className="home-builder-credit" style={{ borderBottom: 0, paddingBottom: 0 }}>
            ...
            {user ? (
              <button
                className="home-club-hint"
                style={{
                  opacity: 1,
                  color: '#ffc247',
                  WebkitTextFillColor: '#ffc247',
                  borderColor: '#ffc247',
                  backgroundColor: 'rgb(255 174 0 / 10%)',
                  fontWeight: 850,
                }}
                type="button"
                onClick={openClubDialog}
                aria-label="Join the NA Computer and AI Club"
              >
                Join <ArrowUpRight size={12} aria-hidden="true" />
              </button>
            ) : null}
          </p>
          ...
          {!user && whyScheduleShareEnabled ? <Link className="home-why-link" to="/why-scheduleshare">Why we're better than Saturn</Link> : null}
