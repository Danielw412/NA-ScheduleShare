  ...
  return (
    <div className="schedule-engine-page">
      <header className="page-heading engine-page-heading">
        <div><h1>Schedule Engine</h1><p>See how your schedule will change if you replace one or more courses. This will become more accurate the more people join, so please invite your friends!</p></div>
